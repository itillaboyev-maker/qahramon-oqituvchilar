...
This file mirrors the repository root `CHANGELOG.md` to preserve the requested docs/decisions structure.
...
- Added: `DuplicateCandidateRepositoryPort` + Drizzle implementation (schema existed
  in the migrations but was completely unused until now).
